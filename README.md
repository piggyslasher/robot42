...
![''][logo]&nbsp;[![Coverage Status](https://coveralls.io/repos/github/piggyslasher/robot42/badge.svg?branch=master)](https://coveralls.io/github/piggyslasher/robot42?branch=master) `// Not proud about that coverage!`
